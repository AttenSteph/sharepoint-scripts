...
# Config Variables
# Example of $TenantAdminURL = "https://contoso-admin.sharepoint.com"
$TenantAdminURL = "https://contoso-admin.sharepoint.com"
$CSVFilePath = ".\SharePointLargeFilesByTenant.csv"
    ...
    ForEach ($List in $DocumentLibraries)
    {
        ...
        ForEach ($File in $Files)
        {
            $FileData += [PSCustomObject][ordered]@{
                ...
                LastModified    = $File.FieldValues.SMLastModifiedDate
...
#Read more: https://www.sharepointdiary.com/2018/11/sharepoint-online-find-all-large-files-using-powershell.html#ixzz8k2Bu0JGw